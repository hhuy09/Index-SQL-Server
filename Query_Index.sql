...
-- CÀI ĐẶT INDEX
-- Tạo chỉ mục nonCluster Index cho RateChangeDate, Rate
CREATE NonClustered INDEX idx_rate
ON dbo.EmployeePayHistory(RateChangeDate, Rate)
GO

-- Tạo chỉ mục nonCluster Index cho department name
CREATE NonClustered INDEX idx_nameD
